        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="index.html" aria-label="Front">
                    <img class="navbar-brand-logo" src="{{ asset('admins\svg\logos\logo.svg') }}" alt="Logo">
                    <img class="navbar-brand-logo-mini" src="{{ asset('admins\svg\logos\logo-short.svg') }}"
                        alt="Logo">
                </a>
                <!-- End Logo -->
            </div>
                                                ...
                                                <li class="list-group-item custom-checkbox-list-wrapper">
                                                    <div class="row">
                                                        ...
                                                        <div class="col ml-n3">
                                                            ...
                                                            <p class="card-text font-size-sm">Accepted your connection
                                                            </p>
                                                        </div>
                                                        <small class="col-auto text-muted text-cap">17dy</small>
                                                    </div>
                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu show">
                            <a class="js-navbar-vertical-aside-menu-link nav-link active" href="index.html"
                                title="Dashboards">
                        ...
                        <li class="navbar-vertical-aside-has-menu ">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle "
                                ...
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Pages</span>
                            </a>
